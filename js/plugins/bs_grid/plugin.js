        ...
        exec: function (editor) {
          ...
          var saveCallback = function (values) {
            ...
            var row_attributes = {
              ...
              'data-row-xl': values.breakpoints.xl.layout
            };
            if (existingElement) {
          ...
          Drupal.ckeditor.openDialog(editor, Drupal.url('ckeditor_bs_grid/dialog'), existingValues, saveCallback, dialogSettings);
        }
      });
